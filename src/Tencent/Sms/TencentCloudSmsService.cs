...
/// 腾讯云短信服务
/// </summary>
internal class TencentCloudSmsService(IConfiguration configuration) : ITencentCloudSmsService
{
    public async Task<List<SendSmsCodeDto>> SendSmsAsync(SendSmsCodeRequest request)
    {
        ...
        {
            SecretId = configuration["TencentCloudSettings:SecretId"],
            SecretKey = configuration["TencentCloudSettings:SecretKey"],
        };
        ...
        {
            // 短信应用ID
            SmsSdkAppId = configuration["TencentCloudSettings:Sms:AppId"],
            // 短信模版ID
            TemplateId = configuration["TencentCloudSettings:Sms:TemplateId"],
            // 短信签名内容
            SignName = configuration["TencentCloudSettings:Sms:SignName"],
            // 模板参数
